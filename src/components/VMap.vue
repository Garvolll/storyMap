<template>
    <div class="amap-page-container">
        <el-amap vid="amapDemo" :center="center" mapStyle="amap://styles/f55e6c52149700def688e88d2fa2ed67" :map-manager="amapManager" :zoom="zoom" :events="events" class="amap-demo">
